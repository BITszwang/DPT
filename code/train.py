...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='DPTx4')
    parser.add_argument('--trainset_dir', type=str, default='/home/wsz/LFDFDATA/LFDFTrainingData/4xSR_5x5')
    parser.add_argument('--testset_dir', type=str, default='/home/wsz/LFDFDATA/LFDFTestingData/4xSR_5x5/')
